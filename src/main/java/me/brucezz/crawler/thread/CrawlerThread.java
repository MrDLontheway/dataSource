                ...
                if (response.contains("chatmsg")){
                    ...
                    if(map.get("gfid")!=null&&Integer.parseInt((String) myHashMap.getOrElse("gfid",0))!=0){
                        ...
                        if(Main.GIFTTOKAFKA){
                            ...
                            Main.producer.send(new KeyedMessage<String, String>(Main.GIFTTOPIC, gift.rid + "",JsonUtils.objectToJson(gift)));//"[date:" +danmaku.getDate()+"]"+ "[房间号:"+danmaku.getRid()+"]"+"["+danmaku.getContent()+"]")
                        }
                    }
                }
